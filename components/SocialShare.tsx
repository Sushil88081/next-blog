...
export default function SocialShare({ url, title, description }: SocialShareProps) {
  ...
  return (
    <div className="flex items-center space-x-4 py-4 border-t border-b border-gray-200 dark:border-gray-700 my-6">
      <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">शेयर करें:</span>
      <div className="flex space-x-3">
        <a
          href={shareLinks.twitter}
          target="_blank"
          rel="noopener noreferrer"
          className="p-2 bg-blue-400 hover:bg-blue-500 text-white rounded-full transition"
        ...
        <a
          ...
          aria-label="LinkedIn पर शेयर करें"
        >
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
